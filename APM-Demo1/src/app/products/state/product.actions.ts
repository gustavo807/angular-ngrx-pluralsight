...
export enum ProductActionTypes {
    ...
    InititalizeCurrentProduct = '[Product] Initialize Current Product',
    Load = '[Product] Load',
...
export class InititalizeCurrentProduct implements Action{
    readonly type = ProductActionTypes.InititalizeCurrentProduct
}
